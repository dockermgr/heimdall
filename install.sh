...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/heimdall"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="heimdall"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/heimdall"
APPDIR="$HOME/.local/share/srv/docker/heimdall"
DATADIR="$HOME/.local/share/srv/docker/heimdall/rootfs"
...
TZ=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default heimdall
CONTAINER_HOSTNAME=""
